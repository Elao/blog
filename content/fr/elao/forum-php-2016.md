...
Nous avons bien aimé ce retour d'expérience sur une application à fort trafic, une sorte de GraphQL fait maison à base d'API REST et du CQRS avec Cassandra en écriture et ElasticSearch en lecture.
...
## Nous avons aussi aimé des sujets très techniques...
...
- [Boost up your code with Specifications](https://slides.pixelart.at/2016-10-28/forumphp/specifications/) par Patrik Karisch
...
ou comment protéger son site web avec les headers php assez méconnus mais absolument indispensables comme le Content Security Policy (CSP).
...
- Sylius eCommerce Framework par Paweł Jędrzejewski
ou comment Sylius peut être utilisé tout ou en partie grâce aux composants.
...
"Allumez le feu" par Frédéric Hardy, une conférence sur... la conférence et le trac d'être conférencier !
Très bonne présentation qui a pour ambition de nous donner envie de nous jetter à l'eau et de transmettre notre savoir en étant nous même conférencier.
...
Merci aux bénévoles de l'AFUP qui ont super bien gérer cet évènement 👍 Vivement l'année prochaine !
